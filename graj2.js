var graj={
	 ...
	 create: function()
	{
		...
		this.gracz.body.collideWorldBounds = true;
...
//		this.key1 = game.input.keyboard.addKey(Phaser.Keyboard.DOWN);
//		this.key1.onDown.add(this.przesun, this);
		},
	update:function()
		{
if (game.input.keyboard.isDown(Phaser.Keyboard.DOWN))this.gracz.y+=10;
if (game.input.keyboard.isDown(Phaser.Keyboard.UP))this.gracz.y-=10;
